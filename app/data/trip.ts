...
export const personalGear: GearItem[] = [
  { id: "gear-01", item: "衣服（快乾；雨林裡二套，含團服）" },
  { id: "gear-02", item: "外套" },
  { id: "gear-03", item: "護照" },
  { id: "gear-04", item: "床墊", note: "Excel 備註：tw.shp.ee/L2ixu7E" },
  { id: "gear-05", item: "蚊帳＋蚊帳線", note: "Excel 備註：tw.shp.ee/dWpV8Jv" },
  { id: "gear-06", item: "現金" },
  { id: "gear-07", item: "零食" },
  { id: "gear-08", item: "肥皂" },
  { id: "gear-09", item: "睡袋（越輕越好）", note: "Excel 備註：tw.shp.ee/fi6NHUo" },
  { id: "gear-10", item: "藥品：蚊蟲、感冒、百靈油、防蚊液" },
  { id: "gear-11", item: "帽子" },
  { id: "gear-12", item: "折疊衣架" },
  { id: "gear-13", item: "盥洗用具：毛巾、牙刷等" },
  { id: "gear-14", item: "手電筒或頭燈" },
  { id: "gear-15", item: "衛生紙、可溶解濕式衛生紙" },
  { id: "gear-16", item: "拖鞋、溯溪鞋" },
  { id: "gear-17", item: "玩具" },
  { id: "gear-18", item: "餐具" },
  { id: "gear-19", item: "大垃圾袋 1 個（自備防水）" },
  { id: "gear-20", item: "可送人的快乾衣服（若有機會）" },
  { id: "gear-21", item: "帽子、墨鏡、雨傘／雨衣" },
  { id: "gear-22", item: "萬用轉接頭、USB 延長線" },
  { id: "gear-23", item: "LED 燈條（一人兩條，行前發）" },
];

export const tripNotes = [
  "護照、機票與住宿資料建議列印紙本；刷卡房費的信用卡要帶，飯店可能再次過卡作為押金，回台後確認是否退還。",
  "大冠鷲代訂房費的手續費由大家均攤；插座要帶三孔轉接頭，USB 充電線不能只帶 Type-C。",
  "個人裝備已獨立整理；雨林膠鞋可到當地購買。",
  "Mulu 國家公園遊客中心可裝飲用水。",
