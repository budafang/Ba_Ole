...
export const tripDays: TripDay[] = [
  {
    ...
    items: [
      ...
      { id: "d19-2", time: "18:50–22:25", title: "亞航 AK1511", location: "TPE → BKI", details: ["台北 TPE 18:50 起飛", "亞庇 BKI 22:25 抵達"], locked: true, status: "planned" },
      ...
      { id: "d19-4", time: "入住", title: "Cotton Houz", location: "亞庇", details: ["4 人房 3 間，不含早餐", "PPT 標示房費 MR911.28（6 男 7 女、每人 489 元），人數與前文 10 人不一致，現場確認"], locked: true, status: "planned" },
    ],
  },
  {
    date: "2026-08-20",
    ...
    items: [
      { id: "d20-1", time: "07:00", title: "飯店退房、前往機場", location: "Cotton Houz → BKI", details: ["10 人搭 3 部車，每車預估 RM40", "抵達機場後先 check in；機場內麥當勞早餐預算約 RM20"], locked: true, status: "planned" },
      { id: "d20-2", time: "07:30", title: "機場報到", location: "亞庇國際機場 BKI", locked: true, status: "planned" },
      { id: "d20-3", time: "10:55–11:50", title: "馬航 MH3251", location: "BKI → MZV", details: ["亞庇國際機場 BKI 10:55 起飛", "Mulu 機場 MZV 11:50 抵達"], locked: true, status: "planned" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "d22-2", time: "13:30–14:00", title: "航班前往 Miri", location: "MZV → MYY", details: ["Mulu MZV 13:30 起飛", "Miri MYY 14:00 抵達"], locked: true, status: "planned" },
  ...
  },
  {
    ...
    items: [
      { id: "d24-1", time: "白天", title: "兒童營隊", location: "Swak Ali", note: "Children’s Camp。", details: ["PPT 標示：備案？", "住宿安排與活動節奏現場確認"], status: "planned" },
  ...
  },
  {
    ...
    items: [
      { id: "d28-1", time: "11:35–12:25", title: "亞航 AK6078", location: "MYY → BKI", note: "抵達亞庇後前往 A Residence。", details: ["Miri 11:35 起飛", "亞庇 12:25 抵達"], locked: true, status: "planned" },
  ...
  },
  {
    ...
    items: [
      { id: "d29-1", time: "04:30", title: "飯店退房", location: "A Residence", details: ["12 人搭 4 部車"], locked: true, status: "planned" },
      { id: "d29-2", time: "05:00", title: "機場報到", location: "BKI", note: "預先確認行李與分車。", locked: true, status: "planned" },
      { id: "d29-3", time: "07:25–11:00", title: "亞航 AK1510", location: "BKI → TPE", note: "可預訂 AirAsia 機上餐點。", details: ["亞庇 BKI 07:25 起飛", "台北 TPE 11:00 抵達"], locked: true, status: "planned" },
    ],
  },
  {
    date: "2026-08-30",
    ...
    items: [
      ...
      { id: "d30-3", time: "09/26", title: "國泰卓越獎助計畫提醒", location: "特色獎助類", note: "返台後續提醒。", details: ["每案獎助 10–20 萬元", "共 20 名／組；截止資訊依 PPT，提交前再確認官方公告"], status: "planned" },
    ],
  },
];
